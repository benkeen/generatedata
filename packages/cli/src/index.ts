/**
 * This file is used to generate dist/index.js and is the "main" entry in the package.json file. Users
 * can import it and get access to the primary `generate` method to programmatically generate random data.
 *
