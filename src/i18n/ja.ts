export default {
	...
	aboutPara5: "For more information on how to extend it, visit the <a href=\\\http://benkeen.github.io/generatedata/developer.html\\\>developer documentation</a>.",
	aboutTitle: "What <i>is</i> this thing?",
	...
	confirmDeleteForm: "本当にフォームを削除してもよろしいですか？",
	confirmDeleteUserAccount: "Are you sure you want to delete this user account?",
	confirmEmptyForm: "本当にフォームをクリアしてもよろしいですか？",
	...
	dataSet: "Data Set",
	dataSetHelp: "This is where you define exactly what kind of data you want to generate. Try filling in a row or two and click the Generate button. Youll get the hang of it pretty fast.",
	...
	exportTypesHelp: "This section lets you control the format of your generated data. Each format may provide different options to let you tailor the output to exactly what you want.",
	extendId: "Extend it",
	extendIt: "Extend it",
	...
	hostName: "Host Name",
	hostNameDesc: "The name of your database connection. Often its just <i>localhost</i>, but sometimes its something like <i>mysql.yoursite.com</i>.",
	humanData: "Human Data",
	infoAndStats: "Info and Stats",
	install: "Install",
	installInvalidDbInfo: "We were unable to connect to the database using the information you supplied. The error message the database returned is: <i>{\\$db_connection_error}</i>",
	installNoDbConnection: "Please check your database name and login information. Although we were able to connect to the database host, we could not connect to the database. The error message the database returned is: <i>{\\$db_select_error}</i>",
	installPluginsRightarrow: "Install Plugins &raquo;",
	installUserDocLink: "For more detailed information about the installation process, check out our <a href=\\\http://benkeen.github.io/generatedata/install.html\\\ target=\\\_blank\\\>user documentation</a>.",
	...
	installationIntro: "Alrighty, lets get this sucker installed. Enter your database information to create your database tables. If youre unsure about any of these fields, click on the Help tab for a little more info.",
	installationPluginIntro: "Almost done! Now were going to install the plugins: these are what make the Data Generator actually <i>useful</i> - i.e. the type of data you can generate (Data Types), the format of the generated data (Export Types) and all the Country-specific data like regions and cities.",
	...
	installationStep3Intro: "You have three choices for the way your installation handles user accounts.",
	invalidAccountId: "The Account ID is not valid.",
	invalidCustomXml: "There&#39;s a problem with the custom XML markup you entered. Please consult the user documentation for more information.",
	...
	invalidTableNames: "Database column names can only alphanumeric characters and must begin with a letter. Please fix the following rows:",
	language: "日本語",
	...
	noJsBlurb: "You know this is, like, the 21st century? The Data Generator script relies heavily on javascript - things just plain wont work without it. You&#39;ll need to enable it in your browser then refresh this page.",
	noNumRows: "Please enter the number of rows to add.",
	noOptionsAvailable: "No options available.",
	noSavedDataSets: "You dont have any saved data sets.",
	noUserAccountsDefined: "No user accounts defined.",
	none: "None",
	northAmerica: "North America",
	notSaved: "not saved",
	notifySettingsUpdated: "Your settings have been updated.",
	...
	plugins: "Plugins",
	pluginsIntro: "Any time you add or remove a plugin, you need to reset the plugins. This will update the database and ensure you can access the plugins you require.",
