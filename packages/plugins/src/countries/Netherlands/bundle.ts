...
const Netherlands: GetCountryData = (i18n) => ({
  ...
  extendedData: {
    ...
    phoneFormat: {
      displayFormats: ['0Xxx-xxxxxx', '0Xx-xxxxxxx', '06-Xxxxxxxxx', '0Xxx xxxxxx', '0Xx xxxxxxx', '06 Xxxxxxxxx', '+31 Xx xxxxxxx', '+31 Xxx xxxxxx', '+31 6 Xxxxxxxxx']
    }
  },
  regions: [
    {
    ...
    },
    {
      ...
      weight: 6,
      cities: ['Bolsward', 'Dokkum', 'Drachten', 'Franeker', 'Harlingen', 'Heerenveen', 'Hindeloopen', 'IJlst', 'Leeuwarden', 'Sloten', 'Sneek', 'Stavoren', 'Workum']
    },
    {
      ...
      weight: 20,
      cities: ['Apeldoorn', 'Arnhem', 'Buren', 'Culemborg', 'Doetinchem', 'Ede', 'Groenlo', 'Harderwijk', 'Hattem', 'Huissen', 'Nijkerk', 'Nijmegen', 'Tiel', 'Wageningen', 'Winterswijk', 'Zaltbommel', 'Zutphen']
    },
    {
      regionName: 'Limburg',
      regionShort: 'L.',
    ...
    },
    {
      ...
      weight: 24,
      cities: ['Bergen op Zoom', 'Breda', 'Eindhoven', 'Geertruidenberg', 'Grave', 'Helmond', 'Heusden', 'Oosterhout', 'Oss', 'Ravenstein', 'Roosendaal', 'Tilburg', 'Waalwijk']
    },
    {
      ...
      weight: 26,
      cities: ['Alkmaar', 'Amstelveen', 'Amsterdam', 'Den Helder', 'Edam', 'Enkhuizen', 'Haarlem', 'Heerhugowaard', 'Hilversum', 'Hoofddorp', 'Hoorn', 'Laren', 'Purmerend', 'Medemblik', 'Muiden', 'Naarden', 'Schagen', 'Weesp', 'Zaanstad']
    },
    {
    ...
    },
    {
      ...
      weight: 12,
      cities: ['Alphen aan den Rijn', 'Delft', 'Dordrecht', 'Gorinchem', 'Gouda', 'Leiden', 'Rotterdam', 'Spijkenisse', 'The Hague', 'Zoetermeer']
    },
    {
      regionName: 'Utrecht',
      regionShort: 'U.',
