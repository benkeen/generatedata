...
export const resolvers: Resolvers = {
  ...
  Mutation: {
    createUserAccount: Mutation_createUserAccount,
    deleteAccount: Mutation_deleteAccount,
    deleteDataSet: Mutation_deleteDataSet,
    login: Mutation_login,
    loginWithGoogle: Mutation_loginWithGoogle,
    logout: Mutation_logout,
    refreshToken: Mutation_refreshToken,
    renameDataSet: Mutation_renameDataSet,
    saveDataSet: Mutation_saveDataSet,
    saveNewDataSet: Mutation_saveNewDataSet,
    sendPasswordResetEmail: Mutation_sendPasswordResetEmail,
    updateAccount: Mutation_updateAccount,
    updateCurrentAccount: Mutation_updateCurrentAccount,
    updateDataSetGenerationCount: Mutation_updateDataSetGenerationCount,
    updatePassword: Mutation_updatePassword
  },
