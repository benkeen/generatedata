...
const Canada: GetCountryData = (i18n) => ({
  ...
  regions: [
    ...
    },
    {
      ...
      weight: 2,
      cities: ["St. John's", 'Springdale', "Spaniard's Bay", 'Rigolet', 'Paradise', 'Mount Pearl', 'McCallum', 'Marystown', 'Harbour Grace', 'Glovertown', 'Gander', 'Fogo', 'Fortune', 'Carbonear', 'Burin', 'Bonavista', 'Bay Roberts'],
      extendedData: {
        zipFormat: {
          format: 'A*@ *@*'
        },
    ...
    },
    {
      ...
      weight: 1,
      cities: ['Yellowknife', 'Wrigley', 'Wha Ti', 'Wekweti', 'Tulita', 'Tuktoyaktuk', 'Tsiigehtchic', 'Sachs Harbour', 'Rae Lakes', 'Rae-Edzo', 'Paulatuk', 'Norman Wells', "Lutsel K'e", 'Kakisa', 'Inuvik', 'Holman', 'Hay River', 'Fort Smith', 'Fort Simpson', 'Fort Resolution', 'Fort Providence', 'Fort McPherson', 'Fort Laird', 'Fort Good Hope', 'Enterprise', 'Deline', 'Coleville Lake', 'Aklavik'],
      extendedData: {
        zipFormat: {
          format: 'X*@ *@*'
        },
    ...
    },
    {
      ...
      weight: 1,
      cities: ['Municipal District', 'Town of Yarmouth', 'Wolfville', 'Pugwash', 'Pictou', 'New Glasgow', 'Halifax', 'Guysborough', 'Cumberland County', 'Cape Breton Island', 'Berwick', 'Baddeck', 'Argyle', 'Annapolis Royal', 'Annapolis County'],
      extendedData: {
        zipFormat: {
          format: 'B*@ *@*'
        },
    ...
    },
    {
      ...
      regionSlug: 'ontario',
      weight: 39,
      cities: ['Ajax', 'Aurora', 'Ancaster Town', 'Barrie', 'Bath', 'Blind River', 'Burlington', 'Caledon', 'Cobourg', 'Cornwall', 'Cumberland', 'East Gwillimbury', 'Essex', 'Etobicoke', 'Gloucester', 'Goderich', 'Grey County', 'Guelph', 'Hamilton', 'Hearst', 'Kapuskasing', 'Kawartha Lakes', 'Kearny', 'King Township', 'Kingston', 'Kitchener', 'Lakeshore', 'Lanark County', 'LaSalle', 'Leamington', 'Malahide', 'Markham', 'Merrickville-Wolford', 'Midlands', 'Township of Minden Hills', 'Minto', 'Newbury', 'Newmarket', 'Norfolk County', 'North Bay', 'Northumberland', 'Orangeville', 'Orilla', 'Osgoode', 'Ottawa', 'Ottawa-Carleton', 'Owen Sound', 'Oxford County', 'Pickering', 'Port Hope', 'Quinte West', 'Ramara', 'Renfrew', 'Richmond Hill', 'Russell', 'Scarborough', 'St. Catharines', 'St. Thomas', 'Greater Sudbury', 'Tay', 'Thorold', 'Thunder Bay', 'Toronto', 'Valley East', 'Vanier', 'Vaughan', 'Warwick', 'Welland', 'Whitby', 'Whitchurch-Stouffville', 'Whitewater Region Township', 'Wilmont', 'Windsor', 'Woodstock'],
      extendedData: {
        zipFormat: {
          format: '^*@ *@*'
        },
    ...
    },
    {
      ...
      regionSlug: 'quebec',
      weight: 23,
      cities: ['Amqui', 'Cabano', 'Dégelis', 'Price', 'Rimouski', 'Rivière-du-Loup', 'Sainte-Flavie', 'Alma', 'Chambord', 'Chicoutimi', 'La Baie', 'Labrecque', 'Saguenay', 'Saint-Prime', 'Shipshaw', 'Baie-Saint-Paul', 'Beauport', 'Cap-Rouge', 'Deschambault', 'Isle-aux-Coudres', 'Lac-Serent', 'Malbaie', 'Neuville', 'Pointe-au-Pic', 'Québec City', 'Saint-Hilarion', 'Saint-Urbain', 'Batiscan', 'Cap-de-la-Madeleine', 'Champlain', 'Pointe-du-Lac', 'Saint-Georges', 'Shawinigan', 'Trois-Rivières', 'Asbestos', 'Richmond', 'Sherbrooke', 'Valcourt', 'Anjou', "Baie-D'Urfé", 'Beaconsfield', 'Côte Saint-Luc', 'Dollard-des-Ormeaux', 'Dorval', 'Hampstead', 'Kirkland', 'Lachine', 'LaSalle', 'Montreal', 'Outremont', 'Pierrefonds', 'Pointe-aux-Trembles', 'Pointe-Claire', 'Roxboro', 'Saint-Laurent', 'Saint-Pierre', 'Senneville', 'Verdun', 'Westmount', 'Aylmer', 'Buckingham', 'Cantley', 'Chelsea', "Collines-de-l'Outaouais", 'Gatineau', 'Hull', 'Ville de Maniwaki', 'Mansfield-et-Pontefract', 'Montebello', 'Montpellier', 'Namur', 'Notre-Dame-de-la-Salette', 'Shawville', 'Thurso', 'Dubuisson', 'Malartic', 'Notre-Dame-du-Nord', 'Rouyn-Noranda', 'Baie-Comeau', 'Fermont', 'Kawawachikamach', 'Matagami', 'Caplan', 'Carleton', 'Gaspé', 'Gespeg', 'Maria', 'Murdochville', 'Cap-Saint-Ignace', 'Charny', 'Lévis'],
      extendedData: {
        zipFormat: {
          format: '&*@ *@*'
        },
    ...
    },
    {
      ...
      weight: 4,
      cities: ['Assiniboia', 'Calder', 'Canora', 'Estevan', 'Gravelbourg', 'Hudson Bay', 'Lang', 'Langenburg', 'Lloydminster', 'Macklin', 'Maple Creek', 'Milestone', 'Moose Jaw', 'North Battleford', 'Prince Albert', 'Regina', 'Saskatoon', 'Weyburn', 'Yorkton'],
      extendedData: {
        zipFormat: {
          format: 'S*@ *@*'
        },
