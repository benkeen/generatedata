...
const Russia: GetCountryData = (i18n) => ({
  ...
  regions: [
    ...
    },
    {
      ...
      weight: 50,
      cities: ['Arkhangelsk', 'Brin-Navolok', 'Kargopol', 'Koryazhma', 'Kotlas', 'Mezen', 'Mirny', 'Novodvinsk', 'Nyandoma', 'Onega', 'Severodvinsk', 'Shenkursk', 'Solvychegodsk', 'Velsk'],
      extendedData: {
        zipFormat: {
          format: '16^***'
        },
    ...
    },
    {
      ...
      weight: 50,
      cities: ['Alexeyevka', 'Belgorod', 'Biryuch', 'Borisovka', 'Grayvoron', 'Gubkin', 'Korocha', 'Krasnaya Yaruga', 'Novy Oskol', 'Rakitnoye', 'Shebekino', 'Stary Oskol', 'Stroitel', 'Valuyki', 'Volokonovka'],
      extendedData: {
        zipFormat: {
          format: '30@***'
        },
    ...
    },
    {
      ...
      weight: 50,
      cities: ['Bryansk', 'Dyatkovo', 'Fokino', 'Karachev', 'Klintsy', 'Mglin', 'Novozybkov', 'Pochep', 'Seltso', 'Sevsk', 'Starodub', 'Surazh', 'Trubchevsk', 'Unecha', 'Vialky', 'Zhukovka', 'Zlynka'],
      extendedData: {
        zipFormat: {
          format: '24P***'
        },
    ...
    },
    {
      ...
      weight: 50,
      cities: ['Asha', 'Bakal', 'Chelyabinsk', 'Karabash', 'Kartaly', 'Kasli', 'Katav-Ivanovsk', 'Kopeysk', 'Korkino', 'Kusa', 'Kyshtym', 'Magnitogorsk', 'Miass', 'Minyar', 'Nyazepetrovsk', 'Ozyorsk', 'Plast', 'Satka', 'Sim', 'Snezhinsk', 'Troitsk', 'Tryokhgorny', 'Ust-Katav', 'Verkhneuralsk', 'Verkhny Ufaley', 'Yemanzhelinsk', 'Yuryuzan', 'Yurzhnouralsk', 'Zlatoust'],
      extendedData: {
        zipFormat: {
          format: '45R***'
        },
