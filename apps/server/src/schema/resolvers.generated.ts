...
import    { dataSet as Query_dataSet } from './dataSets/resolvers/Query/dataSet';
...
import    { settings as Query_settings } from './settings/resolvers/Query/settings';
...
import    { Setting } from './settings/resolvers/Setting';
    export const resolvers: Resolvers = {
      Query: { account: Query_account,accounts: Query_accounts,dataSet: Query_dataSet,dataSetHistory: Query_dataSetHistory,dataSets: Query_dataSets,settings: Query_settings },
