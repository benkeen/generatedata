...
class Names extends DataType {
  ...
  private $dataTypeFieldGroup = "human_data";
  private $dataTypeFieldGroupOrder = 10;
  ...
  function getExportTypeInfo($exportType, $options) {
    $info = "";
    switch ($exportType) {
      case "sql":
  ...
  public function getDataTypeFieldGroup() {
    return $this->dataTypeFieldGroup;
  }

  public function getDataTypeFieldGroupOrder() {
    return $this->dataTypeFieldGroup;
  }
  ...
  // -------- private member functions ---------
	...
	public static function install() {
		...
		Core::getDatabase()->execute($queries);
	}


	public function hasHelpDialog() {
		return true;
	}
