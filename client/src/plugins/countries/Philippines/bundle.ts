	...
	regions: [
		{
			...
			weight: 139,
			cities: [
				'Quezon City', 'Manila', 'Caloocan', 'Taguig', 'Pasig', 'Valenzuela', 'Parañaque', 'Makati', 'Las Piñas',
				'Muntinlupa', 'Marikina'
			]
		},
		{
		...
		},
		{
			...
			weight: 52,
			cities: [
				'Dagupan City', 'Alaminos', 'Batac', 'Candon', 'Laoag', 'San Carlos', 'San Fernando', 'Urdaneta',
				'Vigan'
			]
		},
		{
		...
		},
		{
			...
			weight: 123,
			cities: [
				'Angeles City', 'Balanga', 'Cabanatuan', 'Gapan', 'Mabalacat', 'Malolos', 'Meycauayan', 'Muñoz',
				'Olongapo', 'Palayan', 'San Fernando', 'San Jose', 'San Jose del Monte', 'Tarlac City'
			]
		},
		{
			...
			weight: 161,
			cities: [
				'Antipolo', 'Dasmariñas', 'Bacoor', 'Calamba', 'Imus', 'General Trias', 'Santa Rosa', 'Biñan',
				'Lipa', 'Cabuyao', 'Batangas City', 'San Pedro'
			]
		},
		{
