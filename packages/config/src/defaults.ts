...
/**
 * The default configuration values. These are overridden in the `config.ts` file you create from the `config.example.ts` file 
 * in this folder.
 */
const defaultConfiguration: GenerateDataConfig = {
  database: {
