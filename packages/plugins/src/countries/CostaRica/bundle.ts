...
const CostaRica: GetCountryData = (i18n) => ({
  ...
  regions: [
    ...
    },
    {
      ...
      regionSlug: 'cartago',
      weight: 11,
      cities: ['Aguacaliente (San Francisco]', 'Carmen', 'Cartago', 'Paraíso', 'San Diego', 'San Nicolás', 'San Rafael', 'Tejar', 'Turrialba'],
      extendedData: {
        zipFormat: {
          format: '30xYx',
          replacements: {
    ...
    },
    {
      ...
      regionSlug: 'san_josé',
      weight: 33,
      cities: ['Alajuelita', 'Aserrí', 'Calle Blancos', 'Cinco Esquinas', 'Concepción', 'Curridabat', 'Desamparados', 'Gravilias', 'Guadalupe', 'Ipís', 'Mata de Plátano', 'Patalillo', 'Patarrá', 'Purral', 'San Antonio', 'San Felipe', 'San Isidro', 'San Isidro de El General', 'San José', 'San Juan (San Juan de Tibás]', 'San Juan de Dios', 'San Miguel', 'San Pedro', 'San Rafael', 'San Rafael Abajo', 'San Vicente', 'Tirrases'],
      extendedData: {
        zipFormat: {
          format: '1zxYx',
          replacements: {
