...
export const blacklistedDataTypeFolders = ['_NamesRegional','_PhoneRegional','Currency','NormalDistribution','OrganizationNumber','PAN','PersonalNumber','SIRET','Track1','Track2'];
