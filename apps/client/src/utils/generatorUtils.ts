import type { CountryDataType, CountryNamesMap, DataTypeFolder, GenerationTemplate } from '@generatedata/plugins';
...
let currentSpeed: number = 100; // TODO possible range? 1-100?
...
const generateDataTypeBatch = (options: GenerateDataTypeBrowserBatchProps | GenerateDataTypeNodeBatchProps): Promise<any> =>
  new Promise((resolve) => {
