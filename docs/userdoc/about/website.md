...
the open source script. To cover hosting costs, we added an option for people to donate/register for a user account 
on the site. This lets them save their data sets. 

The same functionality has always been available on the open source version - you just need to download and install the 
script yourself. 
