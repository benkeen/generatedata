...
describe('generateCompanyName', () => {
  ...
  it('generates a company name', () => {
    sinon
      ...
      .onCall(0)
      .returns(1) // number of words
      .onCall(1)
      .returns(0) // company name words offset
      .onCall(2)
      .returns(0); // company type
  ...
  it('picks a random company word', () => {
    sinon
      ...
      .returns(1) // number of words
      .onCall(1)
      .returns(1) // company name words offset
      .onCall(2)
      .returns(0); // company type
  ...
  it('picks a random company type', () => {
    sinon
      ...
      .returns(1) // number of words
      .onCall(1)
      .returns(2) // company name words offset
      .onCall(2)
      .returns(1); // company type
