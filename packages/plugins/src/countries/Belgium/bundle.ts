...
const Belgium: GetCountryData = (i18n) => ({
  ...
  regions: [
    ...
    },
    {
      ...
      weight: 1,
      cities: ['Brussel', 'Laken', 'Schaarbeek', 'Etterbeek', 'Elsene', 'Sint-Gillis', 'Anderlecht', 'Sint-Jans-Molenbeek', 'Koekelberg', 'Sint-Agatha-Berchem', 'Ganshoren', 'Jette', 'Neder-Over-Heembeek', 'Haren', 'Evere', 'Sint-Pieters-Woluwe', 'Oudergem', 'Watermaal-Bosvoorde', 'Ukkel', 'Vorst', 'Sint-Lambrechts-Woluwe', 'Sint-Joost-ten-Node']
    },
    {
    ...
    },
    {
      ...
      regionSlug: 'luik',
      weight: 1,
      cities: ['Glain', 'Luik', 'Rocourt', 'Bressoux', 'Jupille-sur-Meuse', 'LiŽge', 'Wandre', 'GrivegnŽe', 'LiŽge', 'Angleur', 'Herstal', 'Milmort', 'Vottem', 'Liers', 'Chaudfontaine', 'Vaux-sous-ChŽvremont', 'Beaufays', 'Embourg', 'B.S.D.', 'Boncelles', 'Seraing', 'Jemeppe-sur-Meuse', 'OugrŽe', 'Ehein', 'NeuprŽ', 'Rotheux-RimiŽre', 'Neuville-en-Condroz', 'Plainevaux', 'Esneux', 'Tilff', 'Dolembreux', 'GomzŽ-Andoumont', 'Rouvreux', 'Sprimont', 'LouveignŽ', 'Anthisnes', 'Villers-aux-Tours', 'Hody', 'Tavier', 'Comblain-au-Pont', 'Poulseur', 'Comblain-Fairon', 'Comblain-la-Tour', 'Hamoir', 'Filot', 'FerriŽres', 'My', 'Vieuxville', 'Werbomont', 'Xhoris', 'Burdinne', 'Hannche', 'LamontzŽe', 'Marneffe', 'Oteppe', 'HŽron', 'Lavoir', "Waret-l'Evque", 'Couthuin', 'Acosse', 'Ambresin', 'Meeffe', 'Wasseiges', 'Bo‘lhe', 'Geer', 'Hollogne-sur-Geer', 'Lens-Saint-Servais', 'Omal', 'Darion', 'Ligney', 'Berloz', 'Corswarem', 'Rosoux-Crenwick', 'Avennes', 'Braives', 'Ciplet', 'Fallais', 'Fumal', 'Ville-en-Hesbaye', 'Latinne', 'Tourinne', 'Abolens', 'Avernas-le-Bauduin', 'Avin', 'BertrŽe', 'Blehen', 'Cras-Avernas', 'Crehen', 'Grand-Hallet', 'Hannut', 'Lens-Saint-Remy', 'Merdorp', 'Moxhe', 'Petit-Hallet', 'Poucet', 'Thisnes', 'TrognŽe', 'Villers-le-Peuplier', 'Wansin']
    },
    {
      regionName: 'Namen',
      regionShort: 'NA',
