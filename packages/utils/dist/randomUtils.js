...
export const getRandomCharInString = (str) => {
 ...
 *     H       - 0-F
 */
export const generateRandomAlphanumericStr = (str, placeholders = defaultPlaceholders) => {
    if (!str) {
        return '';
    }
    let newStr = '';
...
export const getRandomWeightedSubset = (options, size, allowDuplicates) => {
    const subset = [];
    const weightedOptions = Object.assign({}, options);
 ...
 */
export const generateRandomTextStr = (words, fromStart, min, max) => {
...
export const generatePlaceholderStr = (str, customPlaceholders) => {
    const placeholders = Object.assign(Object.assign({}, defaultPlaceholders), customPlaceholders);
...
export const getRandomWeightedValue = (options) => {
