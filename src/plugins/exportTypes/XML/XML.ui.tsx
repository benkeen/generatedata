...
export const Settings = ({ data, i18n, id, onUpdate }: any): JSX.Element => {
	...
	return (
		<>
			<div>
				<label htmlFor="etXMLRootNodeName">{i18n.root_node_name}</label>
				<input
					type="text"
					name="etXMLRootNodeName"
					id={`${id}-rootNodeName`}
			...
			<div>
				<label htmlFor="etXMLRecordNodeName">{i18n.record_node_name}</label>
				<input
					type="text"
					name="etXMLRecordNodeName"
					id="etXMLRecordNodeName"
