...
describe('generate method converts all placeholders', () => {
  ...
  it('generates two male names', () => {
    sinon.stub(utils.randomUtils, 'getRandomArrayValue').onCall(0).returns('Jim').onCall(1).returns('Bob');
  ...
  it('generates multiple male names', () => {
    sinon.stub(utils.randomUtils, 'getRandomArrayValue').onCall(0).returns('Jim').onCall(1).returns('Jimbo').onCall(2).returns('Bob');
  ...
  it('generates male and female names', () => {
    sinon.stub(utils.randomUtils, 'getRandomArrayValue').onCall(0).returns('Thomas').onCall(1).returns('Susan');
  ...
  it('generates surnames', () => {
    sinon.stub(utils.randomUtils, 'getRandomArrayValue').onCall(0).returns('Whatever');
  ...
  it('generates surnames', () => {
    sinon.stub(utils.randomUtils, 'getRandomCharInString').onCall(0).returns('A');
