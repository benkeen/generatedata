...
const femaleNames = [
	'Aynur', 'Aysel', 'Ayşe', 'Ayşegül', 'Ayşen', 'Ayşenaz', 'Ayşenur', 'Başak', 'Beyza', 'Buket',
...
const maleNames = [
	'Abdullah', 'Abuzer', 'Adem', 'Ahmet', 'Ali̇', 'Ali̇can', 'Ali̇han', 'Ali̇m', 'Ali̇şan', 'Alp',
...
const lastNames = [
	'Acar', 'Adıgüzel', 'Ak', 'Akar', 'Akay', 'Akbaş', 'Akbulut', 'Akdağ', 'Akdemir', 'Akdeniz',
