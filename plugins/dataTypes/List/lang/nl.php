...
$L["at_most"] = "Maximaal";
$L["colours"] = "rood | oranje | geel | groen | blauw | indigo | violet | wit | zwart | zilver | goud";
$L["companies"] = "Microsoft|Apple|Google|Yahoo|Lycos|Altavista|Chami|Adobe|Borland|Lavasoft|Cakewalk|Sibelius|Finale|Unilver|Danone|Proctor and Gamble|Nestle|Bayer";
$L["company_names"] = "Boekhouding | Adverteren | Asset Management | Customer Relations | Klantenservice | Financiën | Personeelszaken | Juridische afdeling | Media Zaken | Salaris Administratie | PR Afdeling | Kwaliteitsgarantie | Sales en Marketing | Onderzoek en Ontwikkeling | Technische ondersteuning";
$L["exactly"] = "Precies";
$L["example_1"] = "Oneven nummers onder de 50";
$L["example_2"] = "Even nummers onder de 50";
$L["example_3"] = "Een-Tien";
$L["example_4"] = "Priemgetallen onder de 100";
$L["example_5"] = "Kleuren";
$L["example_6"] = "Burgerlijke staat";
$L["example_7"] = "Titelatuur";
$L["example_8"] = "Afdelingsnamen";
$L["example_9"] = "Bedrijfsnamen";
$L["example_10"] = "Medicijnen";
$L["example_11"] = "Soorten Eten";
$L["example_12"] = "Automerken";
$L["help"] = "Voer een lijst in met items, gescheiden door een pipe | karakter. Selecteer vervolgens of u wilt <b>Precies</b> X aantal items, of <b>Bij de meeste</b> X items uit de lijst. Meerdere items worden geretourneerd in een door komma's gescheiden lijst in de resultaten. Als u wilt dat uw gegevens ook lege waarden mogen bevatten, voeg dan een of meer pipe tekens aan het eind in - des te meer pipe tekens die u invoert, des te groter de kans dat een lege waarde wordt gegenereerd.";
...
$L["invalid_int_fields"] = "Gelieve enkel getallen in te voeren in de \"Precies\" en \"maximaal\" velden voor de Aangepaste lijst Gegevenstype. Pas AUB de volgende rijen aan:";
$L["one_to_ten"] = "een | twee | drie | vier | vijf | zes | zeven | acht | negen | tien";
$L["prefix"] = "Dr. | De heer | Mevrouw | Ms | Prof. | Drs. | Mr. | Ir. | Ing.";
$L["relationship_states"] = "Alleenstaand | Getrouwd | Gescheiden | Samenwonend";
$L["separated_by_pipe"] = "Voer waarden in gescheiden door |";
...
$L["food_types"] = "pasta|pies|salades|sandwiches|soepen|stoofschotels|granen|schaal-en schelpdieren|nagerechten|noodles";
