...
describe('generateRandomAlphanumericStr', () => {
    ...
    it('special characters are converted as expected', () => {
        ...
        for (let i = 0; i < 50; i++) {
            ...
            expect(randomUtils.consonants
                .concat(randomUtils.lowercaseConsonants)
                .indexOf(generated[2]) !== -1).toBeTruthy();
            // V = uppercase vowel
            ...
            // F = any case vowel
            expect(randomUtils.vowels
                .concat(randomUtils.lowercaseVowels)
                .indexOf(generated[5]) !== -1).toBeTruthy();
            // L = uppercase letter
            ...
            // D = any case letter
            expect(randomUtils.letters
                .concat(randomUtils.lowercaseLetters)
                .indexOf(generated[8]) !== -1).toBeTruthy();
            // X = 1-9
            expect(['1', '2', '3', '4', '5', '6', '7', '8', '9'].indexOf(generated[9]) !==
                -1).toBeTruthy();
            // x = 0-9
            ...
            expect([
                ...
                'E',
                'F'
            ].indexOf(generated[11]) !== -1).toBeTruthy();
        }
    });
});
