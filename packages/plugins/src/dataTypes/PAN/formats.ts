const formatGroup1 = ['XXXXXXXXXXXXXXXX', 'XXXX XXXX XXXX XXXX', 'XXXXXX XXXXXX XXXX', 'XXX XXXXX XXXXX XXX', 'XXXXXX XXXXXXXXXX'];

const formatGroup2 = ['XXXXXXXXXXXXXXX', 'XXXX XXXXXX XXXXX'];
