...
export const SmallScreenSettingsIcon = ({ id, data, dataType, isDataTypeLoaded, Example, Options, i18n, countryI18n, gridPanelDimensions, selectedDataTypeI18n, onConfigureDataType, dtCustomProps }: any): any => {
  ...
  if (Example !== null) {
    example = (
      <>
        <h4>{i18n.example}</h4>
        <div>
          <Example coreI18n={i18n} countryI18n={countryI18n} i18n={selectedDataTypeI18n} id={id} data={data} onUpdate={(data: any): void => onConfigureDataType(id, data)} emptyColClass={sharedStyles.emptyCol} gridPanelDimensions={gridPanelDimensions} />
        </div>
      </>
    );
  }
  ...
  if (Options !== null) {
    ...
    options = (
      <>
        ...
        <Options coreI18n={i18n} countryI18n={countryI18n} i18n={selectedDataTypeI18n} id={id} data={data} onUpdate={(data: any): void => onConfigureDataType(id, data)} gridPanelDimensions={gridPanelDimensions} emptyColClass={sharedStyles.emptyCol} {...dtCustomProps} />
      </>
    );
  }
